      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            These Terms and Conditions outline the rules and regulations for the use of the WIFE4LIFE Islamic Matrimonial 
            Platform. By accessing this platform, we assume you accept these terms. Please refrain from using WIFE4LIFE 
            if you do not agree to all the terms stated on this page.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <ul className="space-y-3 text-gray-700">
            ...
            <li className="flex items-start">
              <span className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
              <strong>Exclusion of Liability Claims:</strong> The owner, business, or brand of WIFE4LIFE is not liable for any disputes arising from interactions between users, including emotional distress or financial loss. WIFE4LIFE shall not be held responsible for any direct, indirect, incidental, or consequential damages arising from the use or inability to use the platform.
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <p className="text-gray-700">
            WIFE4LIFE is not responsible for the accuracy of user-generated content or the outcomes of any matches made.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <p className="text-gray-700">
            By using WIFE4LIFE, you consent to our data collection and use practices.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <p className="text-gray-700">
            Unless otherwise stated, WIFE4LIFE and/or its licensors own the intellectual property rights for all material on 
            the platform. You may access this for personal use, but you must not republish, sell, or exploit content without 
            permission.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <p className="text-gray-700">
            While we strive to provide a safe and secure experience, the owner, business, or brand of WIFE4LIFE shall not 
            be liable for any direct, indirect, incidental, or consequential damages arising from the use or inability to use the 
            platform.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <p className="text-gray-700">
            ...
            <a href="mailto:wife4life@gmail.co.uk" className="text-red-500 hover:text-red-600">
              wife4life@gmail.co.uk
            </a>
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <p className="text-gray-700 mb-6">
            At WIFE4LIFE, we are committed to protecting your privacy and ensuring the security of your personal 
            information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when 
            you use our Islamic matrimonial platform. Last updated: August 2025.
          </p>
          ...
          <p className="text-gray-700 mb-4">You can view and modify your profile information at any time. To request the deletion of your data, please contact us at <a href="mailto:wife4life@gmail.co.uk" className="text-red-500 hover:text-red-600">wife4life@gmail.co.uk</a></p>

          <p className="text-gray-700 mb-4"><strong>Limitation of Liability:</strong> WIFE4LIFE and its owners shall not be liable for any damages arising from the use of your personal information or from any interactions between users. By using our platform, you acknowledge that you understand and agree to this Privacy Policy.</p>

          <p className="text-gray-700">
            <strong>Indemnification:</strong> You agree to indemnify and hold harmless WIFE4LIFE, its owners, and its affiliates from any claims, losses, liabilities, damages, costs, or expenses, including reasonable solicitor fees, arising out of or relating to your use of the platform or your violation of this Privacy Policy.
          </p>
        </div>
      </div>
    </div>
