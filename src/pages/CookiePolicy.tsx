        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              This Cookie Policy explains how WIFE4LIFE uses cookies and similar
              tracking technologies to recognise you when you visit our website.
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
            ...
            <p className="text-gray-700">
              ...
              contact us at{" "}
              <a
                href="mailto:wife4life@gmail.co.uk"
