      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            you use our Islamic matrimonial platform. Last updated: January 2024.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <ul className="space-y-3 text-gray-700">
            ...
            <li className="flex items-start">
              <span className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
              <span><strong>Service Providers:</strong> Trusted partners who help operate our platform</span>
            </li>
            <li className="flex items-start">
              <span className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <div className="bg-red-50 rounded-lg p-6">
            ...
            <p className="text-gray-700 text-sm">
              ...
              <a href="mailto:wife4life@gmail.co.uk" className="text-red-500 hover:text-red-600 ml-1">
